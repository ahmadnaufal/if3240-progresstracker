...
--
-- Host: localhost
-- Generation Time: Apr 07, 2016 at 04:57 AM
...
--
ALTER TABLE `file`
 ADD PRIMARY KEY (`id`), ADD KEY `id_kegiatan` (`id_kegiatan`);
...
--
ALTER TABLE `pesan`
 ADD PRIMARY KEY (`id`), ADD KEY `username_pengguna` (`username_pengguna`);

--
-- Indexes for table `progress`
--
ALTER TABLE `progress`
 ADD KEY `username_pengguna` (`username_pengguna`), ADD KEY `id_kegiatan` (`id_kegiatan`);

--
-- Indexes for table `proyek`
--
ALTER TABLE `proyek`
 ADD PRIMARY KEY (`id`), ADD KEY `username_klien` (`username_klien`);
